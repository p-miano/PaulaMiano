            ...
            <div className="container">
                ...
                <div className="row align-items-center"> {/* Aligns image and text side by side */}
                    ...
                    <div className="col-md-8 text-left"> {/* 2/3 of the width for the text */}
                        ...
                        <p>When I’m not coding, you’ll likely find me practicing French (a new challenge I’m taking on), hiking through trails in search of lakes and waterfalls, or by the sea—though my surfing days are more about wiping out than riding waves! Moving to Canada has given me the chance to experience stunning landscapes, even if the cold winters are still something I’m adjusting to.</p>
