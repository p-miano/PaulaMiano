...
* The `Contact` component provides users with two ways to reach out: through direct email/LinkedIn links or by submitting a contact form.

* **JSX Structure:**
  * **Contact Info:** Includes email, LinkedIn, and GitHub links. These are styled with icons next to the text for better visual appeal.
  * **Contact Form:** A simple form where users can input their name, email, subject, and message. The form is processed using `Getform`.
            ...
            <div className="container">
                ...
                <div className="row">
                    ...
                    <div className="col-md-8">
                        <form action="https://getform.io/f/bmdpldpa" method="POST">
...
* **Styling:** 
  * **Contact Info:** Simple links styled with icons for Email, LinkedIn, and GitHub.
  * **Form Styling:** Styled form fields using Bootstrap’s form-control class and a rounded submit button styled with Bootstrap’s `btn-primary class`.
...
* The `Footer`  component provides basic contact information and social media links. It also displays copyright information.

* **JSX Structure:** 
  * **Social Media Links:** Links for LinkedIn, GitHub, and Email are included with icons for easy identification.
  * **Copyright:** A dynamic copyright message displaying the current year.
...
* **Styling:** The footer uses a dark background (bg-dark) with light text (text-white). Social media icons are styled to change color on hover, providing a simple but effective way to navigate to the user’s profiles.
